...
export function VendorDetail() {
  ...
  return (
    <div className="max-w-7xl mx-auto pb-32 px-0 md:px-4 lg:px-12 space-y-8 md:space-y-12">
      {/* Header & Quick Stats */}
      ...
      <div className="grid grid-cols-12 gap-6 md:gap-8 px-4 md:px-0">
        ...
        <div className="col-span-12 lg:col-span-8 bg-white border border-[#E4EEF0] md:rounded-[48px] p-6 md:p-10 space-y-8 md:space-y-10 shadow-sm rounded-[32px]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1">
              <h3 className="text-lg md:text-xl text-[#075056]">Revenue Performance</h3>
              <p className="text-xs md:text-sm text-[#075056]/40">Verified collection velocity across 6 months.</p>
            </div>
          ...
          <div className="h-64 md:h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={REVENUE_HISTORY} margin={{ left: -20 }}>
                <defs>
